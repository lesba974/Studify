...
object RoutineUtils {
    ...
    fun getMockRoutines(): List<Task> {
        return listOf(
            ...
            Task("Pause", "Pause, bouge un peu - alerte automatique", "Santé", "Si mobile 2h", "Capteur mouvement", Icons.Default.Coffee),
            Task("Sport", "Jogging - Suggéré selon la météo et l'heure", "Santé", "Vers 19:00", "Si beau temps", Icons.Default.MusicNote)
        )
    }
}